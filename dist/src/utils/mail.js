...
exports.estimateHtml = exports.invoiceHtml = exports.nodemailer = exports.transporter = void 0;
const config_1 = __importDefault(require("../config/config"));
const nodemailer_1 = __importDefault(require("nodemailer"));
exports.nodemailer = nodemailer_1.default;
        ...
        <body>
            <div class="container">
                ...
                <div class="invoice-info">
                    ...
                    <div>Create Date:  ${(0, moment_1.default)(data.createDate).format('MMM DD yyyy')}</div>
                    <div>Due Date:  ${(0, moment_1.default)(data.dueDate).format('MMM DD yyyy')}</div>
                    <div>Status:  
...
exports.estimateHtml = estimateHtml;
